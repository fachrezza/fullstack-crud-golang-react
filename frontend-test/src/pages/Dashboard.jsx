            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-md">
                  ...
                  <h1 className="text-2xl font-bold mt-3 text-purple-600">
                    Active User
                  </h1>
              ...
              <div className="bg-white rounded-2xl shadow-md p-8">
                ...
                <p className="text-gray-600">
                  User hanya dapat melihat statistik data mahasiswa.
                </p>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-md">
                  ...
                  <h1 className="text-2xl font-bold mt-3 text-red-500">
                    Administrator
                  </h1>
